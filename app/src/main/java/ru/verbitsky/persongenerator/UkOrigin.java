...
/**
 * Класс, который генерирует Имя и Фамилию для фейковых пользователей с британским происхождением
 */

public class UkOrigin implements Origin{

   String sex;

   String[] MiddleName = {"A.", "B.", "C.", "D.", "E.", "F.",
            "G.", "I.", "H.", "J.", "K.", "L.", "M.", "N.",
            "P.", "R.", "S.", "T.", "V.", "Z.", "Y."};
   ...
   private String[] FemaleName = {"Mary", "Patricia", "Jennifer", "Elizabeth", "Linda", "Barbara", "Susan", "Jessica",
    ...
    /**
     * @return Возвращает случайную фамилию из массива данных фамилий (список самых популярных британских фамилий)
     */
     ...
     * @return Возвращает случайное имя из массива данных имен (список самых популярных мужских бритнаских имен)
     */
    ...
    public String name() {
        ...
        if(sex.equals("male")){
            ...
            return "Mr. " + MaleName[(int)(Math.random()*MaleName.length)];

        }else{

            return "Mrs. "+ FemaleName[(int)(Math.random()*FemaleName.length)];
